    ...
    <>
      ...
      <main className="pt-20 pb-24 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="font-headline text-2xl text-on-surface mb-2">Archive</h2>
          <p className="text-on-surface-variant">Past debates and conversations will appear here.</p>

    ...
    <>
      <main className="pt-16 pb-40 md:pb-32 min-h-screen">
        <div className="flex flex-col md:flex-row">
          {/* Hero Image - 1/3 width, fixed on desktop */}
          <section className="relative w-full md:w-1/3 h-[397px] md:h-screen overflow-hidden bg-surface-container-lowest md:fixed md:left-0 md:top-16">
            ...
            <div className="absolute bottom-0 left-0 w-full px-6 pb-12">
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                <h2 className="font-headline text-5xl md:text-6xl font-bold tracking-tighter uppercase leading-none">
                ...
                <p className="text-primary/80 text-sm font-body italic mt-2 max-w-xl">
                  &ldquo;{tagline}&rdquo;
                </p>
              </div>
            </div>
          ...
          {/* Content - 2/3 width, scrolls on desktop */}
          <div className="w-full md:w-2/3 md:ml-auto px-6 mt-12 md:mt-0 md:pt-24 pb-40">
            ...
            <div className="max-w-4xl flex flex-col gap-12 mt-12">
